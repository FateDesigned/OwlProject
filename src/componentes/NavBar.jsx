  ...
  return (
    <div className="navBar">
      ...
      <div className="mainNav">
        ...
        {/* Abrir Nav */}
          <div href="#" className="openNavBarBox" id="menu-button">
      ...
      {/*Nav*/}
        ...
        <div className="noProfileNav" id="btn-login-register">
                <Link to='/registro'>
                    <button className="btnLogin" id="RegisterUser-inicio"> Registrarse </button>
                </Link>

                <Link to='/login'>
                    <button className="btnLogin"id="LoginUser-inicio"> Inicia Sesion </button>
                </Link>
        </div>
      </div>
